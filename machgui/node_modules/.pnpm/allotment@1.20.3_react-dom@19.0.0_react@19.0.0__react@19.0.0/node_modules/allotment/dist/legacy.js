...
var h,
  l = i(function () {
    ...
    function l(o) {
      ...
      o = o.replace(i, "");
      var l = s.test(o);
      return l || r.test(o) ? u(o.slice(2), l ? 2 : 8) : n.test(o) ? e : +o;
    }
...
var m = (h || (h = 1, function (e, i) {
    ...
    function Le(e, t) {
      var i = Ge(e),
        ...
        u = a.length;
      for (var c in e) !q.call(e, c) || o && ("length" == c || s && ("offset" == c || "parent" == c) || r && ("buffer" == c || "byteLength" == c || "byteOffset" == c) || $e(c, u)) || a.push(c);
      return a;
    }
    function Oe(e, t) {
    ...
    function De(e) {
      return null == e ? void 0 === e ? x : y : ae && ae in Object(e) ? function (e) {
        ...
        var s = ee.call(e);
        return n && (t ? e[ae] = i : delete e[ae]), s;
      }(e) : function (e) {
        return ee.call(e);
      }(e);
    }
    ...
    function Me(e, t, i, n, o) {
      return e === t || (null == e || null == t || !Ze(e) && !Ze(t) ? e != e && t != t : function (e, t, i, n, o, c) {
        ...
        return !!E && (c || (c = new je()), function (e, t, i, n, r, o) {
          var a = i & s,
            u = Te(e),
            c = u.length,
            h = Te(t),
...
var H = i(function () {
    ...
    function v(t) {
      ...
      t = t.replace(n, "");
      var c = r.test(t);
      return c || o.test(t) ? a(t.slice(2), c ? 2 : 8) : s.test(t) ? e : +t;
    }
    return P = function P(e, t, i) {
      ...
      return t = v(t) || 0, p(i) && (h = !!i.leading, r = (l = "maxWait" in i) ? f(v(i.maxWait) || 0, t) : r, y = "trailing" in i ? !!i.trailing : y), S.cancel = function () {
  ...
  return _createClass(ue, [{
    ...
    value: function moveView(e, t, i) {
      var n = this.getViewCachedVisibleSize(t),
        s = void 0 === n ? this.getViewSize(t) : ie.Invisible(n),
        r = this.removeView(t);
    ...
    value: function resizeView(e, t) {
      ...
      var i = R(0, this.viewItems.length).filter(function (t) {
        ...
        r = this.viewItems[e];
      t = Math.round(t), t = l(t, r.minimumSize, Math.min(r.maximumSize, this.size)), r.size = t, this.relayout(n, s);
    }
  }, {
    key: "resizeViews",
    value: function resizeViews(e) {
      for (var _t5 = 0; _t5 < e.length; _t5++) {
        ...
        var _n3 = e[_t5];
        _n3 = Math.round(_n3), _n3 = l(_n3, _i5.minimumSize, Math.min(_i5.maximumSize, this.size)), _i5.size = _n3;
      }
    ...
    value: function resize(e, t) {
      ...
      for (var _e14 = 0, _i11 = t = l(t, z, w); _e14 < f.length; _e14++) {
        var _t9 = f[_e14],
          _n4 = l(m[_e14] + _i11, _t9.minimumSize, _t9.maximumSize);
        _i11 -= _n4 - m[_e14], _t9.size = _n4;
      }
      for (var _e15 = 0, _i12 = t; _e15 < d.length; _e15++) {
        var _t10 = d[_e15],
          _n5 = l(p[_e15] - _i12, _t10.minimumSize, _t10.maximumSize);
        _i12 += _n5 - p[_e15], _t10.size = _n5;
      }
      return t;
    }
  }, {
    ...
    value: function distributeEmptySpace(e) {
      ...
      for (var _e16 = 0; 0 !== i && _e16 < n.length; _e16++) {
        var _t11 = this.viewItems[n[_e16]],
          _s3 = l(_t11.size + i, _t11.minimumSize, _t11.maximumSize);
    ...
    value: function updateSashEnablement() {
      ...
      for (var _e17 = 0; _e17 < this.sashItems.length; _e17++) {
        ...
        if (_a && _u) {
          var _i13 = R(_e17, -1, -1),
            _r2 = R(_e17 + 1, this.viewItems.length),
          ...
          _c && s[_e17] && (o > 0 || this.startSnappingEnabled) ? _n6.state = q.Minimum : _h && t[_e17] && (o < this.contentSize || this.endSnappingEnabled) ? _n6.state = q.Maximum : _n6.state = q.Disabled;
        } else _n6.state = _a && !_u ? q.Minimum : !_a && _u ? q.Maximum : q.Enabled;
      }
    }
  }, {
...
var fe = /*#__PURE__*/function () {
  ...
  return _createClass(fe, [{
    ...
    set: function set(e) {
      if ("number" == typeof e) this.layoutStrategy = new ce(e);else if ("string" == typeof e) {
        var _t18 = e.trim();
        if (D(_t18, "%")) {
          var _e21 = Number(_t18.slice(0, -1)) / 100;
          this.layoutStrategy = new he(_e21, this.layoutService);
        } else if (D(_t18, "px")) {
          var _e22 = Number(_t18.slice(0, -2)) / 100;
          this.layoutStrategy = new ce(_e22);
        } else if ("number" == typeof Number.parseFloat(_t18)) {
          var _e23 = Number.parseFloat(_t18);
          this.layoutStrategy = new ce(_e23);
        } else this.layoutStrategy = new le();
      } else this.layoutStrategy = new le();
    }
  }, {
...
var de = e.forwardRef(function (_ref3, n) {
...
de.displayName = "Allotment.Pane";
var pe = e.forwardRef(function (_ref4, x) {
  ...
  var F = e.useMemo(function () {
    ...
    k = e.useCallback(function (e) {
      ...
      return "number" == typeof (t === null || t === void 0 ? void 0 : t.preferredSize) && ((_N$current = N.current) !== null && _N$current !== void 0 && _N$current.resizeView(e, Math.round(t.preferredSize)), !0);
    }, []);
  return e.useImperativeHandle(x, function () {
    return {
      reset: function reset() {
        if (p) p();else {
          var _N$current2;
          (_N$current2 = N.current) === null || _N$current2 === void 0 || _N$current2.distributeViewSizes();
          for (var _e24 = 0; _e24 < A.current.length; _e24++) k(_e24);
        }
      },
      resize: function resize(e) {
        var _N$current3;
        (_N$current3 = N.current) === null || _N$current3 === void 0 || _N$current3.resizeViews(e);
      }
    };
  }), L(function () {
    var e = !0;
    h && M.current.size !== h.length && (e = !1, console.warn("Expected ".concat(h.length, " children based on defaultSizes but found ").concat(M.current.size))), e && h && (j.current = F.map(function (e) {
      return e.key;
    }));
    var t = _objectSpread({
      orientation: f ? Z.Vertical : Z.Horizontal,
      ...
      descriptor: {
        ...
        views: h.map(function (e, t) {
          ...
          var i = D.current.get(j.current[t]),
            n = new fe(P.current, _objectSpread(_objectSpread({
          ...
          return A.current.push(n), {
            container: _toConsumableArray(M.current.values())[t],
            size: e,
            view: n
          };
        })
    ...
    N.current = new ue(E.current, t, m, z, I), N.current.on("sashDragStart", function () {
      var _E$current;
      (_E$current = E.current) === null || _E$current === void 0 || _E$current.classList.add("split-view-sash-dragging");
    }), N.current.on("sashDragEnd", function () {
      var _E$current2;
      (_E$current2 = E.current) === null || _E$current2 === void 0 || _E$current2.classList.remove("split-view-sash-dragging");
    }), N.current.on("sashchange", function (e) {
      if (b && N.current) {
        var _e25 = F.map(function (e) {
          return e.key;
        });
        for (var _t19 = 0; _t19 < _e25.length; _t19++) {
          var _i14 = D.current.get(_e25[_t19]);
          void 0 !== (_i14 === null || _i14 === void 0 ? void 0 : _i14.visible) && _i14.visible !== N.current.isViewVisible(_t19) && b(_t19, N.current.isViewVisible(_t19));
        }
      }
    }), N.current.on("sashreset", function (e) {
      if (p) p();else {
        var _N$current4;
        if (k(e)) return;
        if (k(e + 1)) return;
        (_N$current4 = N.current) === null || _N$current4 === void 0 || _N$current4.distributeViewSizes();
      }
    });
    var i = N.current;
    return function () {
    ...
    if (C) {
      var _e26 = F.map(function (e) {
        ...
        _t20 = _toConsumableArray(j.current),
      ...
      for (var _e27 = _o.length - 1; _e27 >= 0; _e27--) {
        var _N$current5;
        _o[_e27] && ((_N$current5 = N.current) !== null && _N$current5 !== void 0 && _N$current5.removeView(_e27), _t20.splice(_e27, 1), A.current.splice(_e27, 1));
      }
      var _iterator9 = _createForOfIteratorHelper(_i15),
        _step9;
      try {
        var _loop3 = function _loop3() {
          var _i$minSize2, _i$maxSize2, _i$priority2, _i$snap2, _N$current9;
          var n = _step9.value;
          var i = D.current.get(n),
            o = new fe(P.current, _objectSpread(_objectSpread({
              element: document.createElement("div"),
          ...
          (_N$current9 = N.current) !== null && _N$current9 !== void 0 && _N$current9.addView(M.current.get(n), o, ie.Distribute, _e26.findIndex(function (e) {
            return e === n;
      ...
      for (; !d(_e26, _t20);) {
        ...
        try {
          var _loop = function _loop() {
            ...
            if (e !== i) {
              var _N$current6;
              (_N$current6 = N.current) === null || _N$current6 === void 0 || _N$current6.moveView(M.current.get(n), e, i);
              var _s4 = _t20[e];
      ...
      try {
        var _loop4 = function _loop4() {
          ...
          void 0 !== n && ((_N$current10 = N.current) === null || _N$current10 === void 0 ? void 0 : _N$current10.resizeView(i, n));
        };
      ...
      var _loop2 = function _loop2() {
        var _N$current7, _N$current8;
        var t = _arr[_i16];
        var i = D.current.get(t),
          n = _e26.findIndex(function (e) {
            return e === t;
          });
        i && me(i) && void 0 !== i.visible && ((_N$current7 = N.current) === null || _N$current7 === void 0 ? void 0 : _N$current7.isViewVisible(n)) !== i.visible && ((_N$current8 = N.current) === null || _N$current8 === void 0 ? void 0 : _N$current8.setViewVisible(n, i.visible));
      };
      ...
      try {
        var _loop5 = function _loop5() {
          ...
          if (i && me(i)) {
            ...
            var _e28 = !1;
            void 0 !== i.minSize && A.current[n].minimumSize !== i.minSize && (A.current[n].minimumSize = i.minSize, _e28 = !0), void 0 !== i.maxSize && A.current[n].maximumSize !== i.maxSize && (A.current[n].maximumSize = i.maxSize, _e28 = !0), _e28 && ((_N$current11 = N.current) === null || _N$current11 === void 0 ? void 0 : _N$current11.layout());
          }
        };
      ...
      (_i15.length > 0 || _o.length > 0) && (j.current = _e26);
    }
  }, [F, C, s, r, l]), e.useEffect(function () {
    N.current && (N.current.onDidChange = m);
  }, [m]), e.useEffect(function () {
    N.current && (N.current.onDidDragStart = z);
  }, [z]), e.useEffect(function () {
    N.current && (N.current.onDidDragEnd = I);
  }, [I]), v({
    ref: E,
    onResize: function onResize(_ref5) {
      ...
      var e = _ref5.width,
        t = _ref5.height;
      e && t && ((_N$current12 = N.current) !== null && _N$current12 !== void 0 && _N$current12.layout(f ? t : e), P.current.setSize(f ? t : e), T(!0));
    }
  }), e.useEffect(function () {
    V && ve(20);
  }, []), e.createElement("div", {
    ...
    return "Allotment.Pane" === t.type.displayName ? (D.current.set(i, t.props), e.cloneElement(t, {
      ...
      ref: function ref(e) {
        var n = t.ref;
        n && (n.current = e), e ? M.current.set(i, e) : M.current["delete"](i);
      }
    })) : e.createElement(de, {
      key: i,
      ref: function ref(e) {
...
function ve(e) {
  ...
  document.documentElement.style.setProperty("--sash-size", t + "px"), document.documentElement.style.setProperty("--sash-hover-size", i + "px"), function (e) {
    Q = e, ee.emit("onDidChangeGlobalSize", e);
  }(t);
}
pe.displayName = "Allotment";
var ye = Object.assign(pe, {
  Pane: de
});
exports.Allotment = ye, exports.LayoutPriority = se, exports.setSashSize = ve;
