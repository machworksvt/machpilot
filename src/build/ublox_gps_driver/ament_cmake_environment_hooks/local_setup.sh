...
: ${AMENT_CURRENT_PREFIX:="/workspace/src/install/ublox_gps_driver"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ublox_gps_driver/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/ublox_gps_driver/environment/path.sh"
