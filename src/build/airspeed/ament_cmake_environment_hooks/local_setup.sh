...
: ${AMENT_CURRENT_PREFIX:="/workspace/src/install/airspeed"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/airspeed/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/airspeed/environment/path.sh"
