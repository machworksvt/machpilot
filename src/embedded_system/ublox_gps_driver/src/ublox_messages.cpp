...
std::pair<uint8_t, uint8_t> calculateChecksum(const uint8_t* data, size_t length) {
...
bool verifyChecksum(const uint8_t* data, size_t length, uint8_t ck_a, uint8_t ck_b) {
